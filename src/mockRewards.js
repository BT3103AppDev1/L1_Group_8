    ...
    const rewards = [
        {
            ...
            reward_details: '$5 off any meal at Jollibee NUS outlets.',
            redemption_instruction: 'Show this reward card at the counter to redeem.',
        ...
        },
        {
            ...
            redemption_instruction: 'Present this reward card at the cashier to redeem.',
            terms_and_conditions: 'Valid for one-time use only. Not valid on public holidays.',
        ...
        },
        {
            ...
            redemption_instruction: 'Show this reward card to the barista before placing your order.',
            terms_and_conditions: 'Valid for one-time use only. Not valid with other promotions.',
        ...
        },
        {
            ...
            terms_and_conditions: 'Valid for one-time use only. Not valid on textbooks.',
        ...
        },
        {
            ...
            redemption_instruction: 'Show this reward card to the cashier when ordering your meal.',
            terms_and_conditions: 'Valid for one-time use only. Not valid with other offers.',
            expiry_date: futureDate(30),
            created_at: Timestamp.now(),
        },
    ];
